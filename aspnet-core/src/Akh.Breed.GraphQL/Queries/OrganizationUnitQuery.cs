...
using Akh.Breed.Core.Base;
using Akh.Breed.Core.Extensions;
using Akh.Breed.Dto;
using Akh.Breed.Types;

namespace Akh.Breed.Queries
{
    public class OrganizationUnitQuery : BreedQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
