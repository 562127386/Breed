...
using Akh.Breed.MultiTenancy.Demo;
...
namespace Akh.Breed.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(BreedConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
