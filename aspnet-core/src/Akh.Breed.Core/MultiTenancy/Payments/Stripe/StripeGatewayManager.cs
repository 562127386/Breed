...
namespace Akh.Breed.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : BreedServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Breed";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + BreedConsts.Currency;
        }
