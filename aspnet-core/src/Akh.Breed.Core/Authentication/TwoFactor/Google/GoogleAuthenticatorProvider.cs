...
namespace Akh.Breed.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : BreedServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Akh.Breed", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
