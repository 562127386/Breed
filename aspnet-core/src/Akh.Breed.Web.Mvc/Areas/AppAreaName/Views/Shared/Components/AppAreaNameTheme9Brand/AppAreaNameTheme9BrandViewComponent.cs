...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme9Brand
{
    public class AppAreaNameTheme9BrandViewComponent : BreedViewComponent
    {
