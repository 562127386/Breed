...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme3Footer
{
    public class AppAreaNameTheme3FooterViewComponent : BreedViewComponent
    {
