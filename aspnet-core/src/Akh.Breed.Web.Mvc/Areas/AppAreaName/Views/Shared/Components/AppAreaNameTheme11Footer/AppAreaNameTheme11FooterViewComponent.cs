...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme11Footer
{
    public class AppAreaNameTheme11FooterViewComponent : BreedViewComponent
    {
