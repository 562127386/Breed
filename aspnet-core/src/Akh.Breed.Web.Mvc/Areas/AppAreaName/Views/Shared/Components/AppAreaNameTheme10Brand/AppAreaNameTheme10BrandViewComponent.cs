...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme10Brand
{
    public class AppAreaNameTheme10BrandViewComponent : BreedViewComponent
    {
