...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme2Footer
{
    public class AppAreaNameTheme2FooterViewComponent : BreedViewComponent
    {
