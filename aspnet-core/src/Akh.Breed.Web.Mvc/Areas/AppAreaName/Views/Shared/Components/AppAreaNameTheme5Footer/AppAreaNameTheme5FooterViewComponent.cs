...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme5Footer
{
    public class AppAreaNameTheme5FooterViewComponent : BreedViewComponent
    {
