...
namespace Akh.Breed.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme9Footer
{
    public class AppAreaNameTheme9FooterViewComponent : BreedViewComponent
    {
