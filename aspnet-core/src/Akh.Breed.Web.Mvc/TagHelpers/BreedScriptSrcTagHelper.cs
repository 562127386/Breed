...
namespace Akh.Breed.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class BreedScriptSrcTagHelper : TagHelper
    {
        ...
        public BreedScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
