...
{
    public class SubscriptionPaymentExtensionDataRepository : BreedRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<BreedDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
