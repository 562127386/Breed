...
using Akh.Breed.EntityFrameworkCore.Repositories;

namespace Akh.Breed.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : BreedRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<BreedDbContext> dbContextProvider)
