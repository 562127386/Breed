...
using Akh.Breed.Web.Authentication.JwtBearer;
using Akh.Breed.Web.Authentication.TwoFactor;
using Akh.Breed.Web.Chat.SignalR;
using Akh.Breed.Web.Configuration;
using Akh.Breed.Web.DashboardCustomization;

namespace Akh.Breed.Web
{
    [DependsOn(
        typeof(BreedApplicationModule),
        typeof(BreedEntityFrameworkCoreModule),
    ...
    public class BreedWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BreedWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(BreedApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BreedWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(BreedWebCoreModule).Assembly);
        }
