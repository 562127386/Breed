...
namespace Akh.Breed.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(BreedDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    BreedDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Tenant.TopStats,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Host.TopStats,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            WidgetViewDefinitions.Add(BreedDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
                    BreedDashboardCustomizationConsts.Widgets.Host.RecentTenants,
