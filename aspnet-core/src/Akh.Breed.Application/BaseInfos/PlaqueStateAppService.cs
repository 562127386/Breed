...
namespace Akh.Breed.BaseInfos
{
    public class PlaqueStateAppService :  BreedAppServiceBase, IPlaqueStateAppService
    {
        ...
        [AbpAuthorize(AppPermissions.Pages_BaseInfo_PlaqueState)]
        ...
        [AbpAuthorize(AppPermissions.Pages_BaseInfo_PlaqueState_Create, AppPermissions.Pages_BaseInfo_PlaqueState_Edit)]
        ...
        [AbpAuthorize(AppPermissions.Pages_BaseInfo_PlaqueState_Delete)]
        ...
        [AbpAuthorize(AppPermissions.Pages_BaseInfo_PlaqueState_Edit)]
        ...
        [AbpAuthorize(AppPermissions.Pages_BaseInfo_PlaqueState_Create)]
