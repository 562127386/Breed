...
using Akh.Breed.Auditing.Exporting;
using Akh.Breed.Authorization;
using Akh.Breed.Authorization.Users;
using Akh.Breed.Dto;
using Akh.Breed.EntityHistory;
using EntityHistoryHelper = Akh.Breed.EntityHistory.EntityHistoryHelper;

namespace Akh.Breed.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : BreedAppServiceBase, IAuditLogAppService
    {
