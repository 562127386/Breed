...
using Akh.Breed.UiCustomization;

namespace Akh.Breed.Sessions
{
    public class SessionAppService : BreedAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = BreedConsts.Currency,
                    CurrencySign = BreedConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = BreedConsts.AllowTenantsToChangeEmailSettings
                }
            };
