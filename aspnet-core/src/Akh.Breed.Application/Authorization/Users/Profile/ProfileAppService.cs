...
using Akh.Breed.Authentication.TwoFactor.Google;
using Akh.Breed.Authorization.Users.Dto;
using Akh.Breed.Authorization.Users.Profile.Cache;
using Akh.Breed.Authorization.Users.Profile.Dto;
using Akh.Breed.Friendships;
using Akh.Breed.Gdpr;
...
namespace Akh.Breed.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : BreedAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Akh.Breed",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Akh.Breed",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
