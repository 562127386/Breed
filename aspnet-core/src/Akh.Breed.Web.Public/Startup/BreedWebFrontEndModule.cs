...
namespace Akh.Breed.Web.Public.Startup
{
    [DependsOn(
        typeof(BreedWebCoreModule)
    )]
    public class BreedWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BreedWebFrontEndModule(IWebHostEnvironment env, BreedEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BreedWebFrontEndModule).GetAssembly());
        }
    }
}
