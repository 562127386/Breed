...
using MvvmHelpers;
using Akh.Breed.Authorization.Users.Profile;
using Akh.Breed.Authorization.Users.Profile.Dto;
using Akh.Breed.Commands;
using Akh.Breed.Core.Threading;
using Akh.Breed.Models.NavigationMenu;
using Akh.Breed.Services.Navigation;
...
using Akh.Breed.ApiClient;
using Akh.Breed.Controls;
using Akh.Breed.Dto;
using Akh.Breed.Extensions;
using Akh.Breed.Localization;
using Akh.Breed.UI;
using Akh.Breed.UI.Assets;
using Akh.Breed.Views;
using DependencyResolver = Akh.Breed.Core.Dependency.DependencyResolver;
...
namespace Akh.Breed.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Breed";
