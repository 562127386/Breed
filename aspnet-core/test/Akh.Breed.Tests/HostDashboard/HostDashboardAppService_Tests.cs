...
using Akh.Breed.MultiTenancy.HostDashboard;
...
namespace Akh.Breed.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(BreedDbContext context, SubscriptionPayment subscriptionPayment)
        {
