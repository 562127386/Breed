...
@Component({
    templateUrl: './themeAkhBreed-theme-ui-settings.component.html',
    animations: [appModuleAnimation()],
    selector: 'themeAkhBreed-theme-ui-settings'
})
export class ThemeAkhBreedThemeUiSettingsComponent extends AppComponentBase {
