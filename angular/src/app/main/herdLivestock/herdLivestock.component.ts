...
import { ReportHerdLivestockModalComponent } from './report-herdLivestock-modal.component';
...
export class HerdLivestockComponent extends AppComponentBase implements OnInit, AfterViewInit {

    @ViewChild('reportHerdLivestockModal', { static: true }) reportHerdLivestockModal: ReportHerdLivestockModalComponent;
    ...
    ngOnInit() {
        ...
        this._activatedRoute.queryParams.subscribe(params => {
            ...
            if(this.isCreateForm !== undefined && this.isCreateForm == 1){                
                this.reportHerdLivestockModal.show();
            }
          });
      }
