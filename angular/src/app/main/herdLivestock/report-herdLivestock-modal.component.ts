...
@Component({
    selector: 'reportHerdLivestockModal',
    templateUrl: './report-HerdLivestock-modal.component.html'
})
export class ReportHerdLivestockModalComponent extends AppComponentBase {
